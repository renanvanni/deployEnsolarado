...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ensolarado documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-a59ef6b8e5e97aa4077ac42374104ace"' : 'data-target="#xs-components-links-module-AppModule-a59ef6b8e5e97aa4077ac42374104ace"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-a59ef6b8e5e97aa4077ac42374104ace"' :
                                            'id="xs-components-links-module-AppModule-a59ef6b8e5e97aa4077ac42374104ace"' }>
                                            <li class="link">
